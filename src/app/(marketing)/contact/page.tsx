            ...
            <div className="container mx-auto px-5 md:px-4 relative z-10">
                <RevealOnScroll>
                    <div className="max-w-3xl mx-auto text-center mb-10 md:mb-16">
                        <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-white mb-4 md:mb-6 leading-tight">Get In Touch</h1>
                        <p className="text-white/40 text-base md:text-lg">Ready for a cleaner space? Whether it&apos;s a luxury residence or a commercial property, our team is ready to help.</p>
                    </div>
                </RevealOnScroll>
                        ...
                        <RevealOnScroll delay={0.1}>
                            <div className="bg-[#111111] border border-white/5 rounded-2xl md:rounded-3xl p-6 md:p-8 flex items-start gap-4 md:gap-6 hover:border-[#FFD700]/30 transition-colors">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/40 text-sm mb-3 md:mb-4">Fastest way to reach us.</p>
                                    <a href="tel:+14165550123" className="text-lg md:text-xl font-accent font-bold text-white hover:text-[#FFD700] transition-colors">+1 (416) 555-0123</a>
                                </div>
                            </div>
                        </RevealOnScroll>
                        ...
                        <RevealOnScroll delay={0.3}>
                            <div className="bg-[#111111] border border-white/5 rounded-2xl md:rounded-3xl p-6 md:p-8 flex flex-col gap-5 md:gap-6 hover:border-[#FFD700]/30 transition-colors">
                                <div className="flex items-start gap-4 md:gap-6">
                                    ...
                                    <div>
                                        <h3 className="font-heading font-bold text-lg md:text-xl text-white mb-1 md:mb-2">Service Areas</h3>
                                        <p className="text-white/40 text-sm leading-relaxed">Toronto, Mississauga, Brampton,<br />Vaughan, Oakville & more</p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-[#111111]/80 backdrop-blur-md border border-white/10 rounded-2xl md:rounded-3xl p-6 md:p-12 h-full">
                            ...
                            {status === "success" ? (
                                <div className="flex flex-col items-center justify-center py-16 gap-4 text-center">
                                    ...
                                    <p className="text-white/40">We&apos;ll be in touch within 24 hours.</p>
                                    <button
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                        <div className="space-y-1.5 md:space-y-2">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-black border border-white/10 rounded-xl px-4 py-3.5 md:py-3 text-white text-base focus:outline-none focus:border-[#FFD700] focus:ring-1 focus:ring-[#FFD700] transition-all"
                                                placeholder="Jane"
                                            />
                                        </div>
                                        <div className="space-y-1.5 md:space-y-2">
                                    ...
                                    <div className="space-y-1.5 md:space-y-2">
                                        ...
                                        <select
                                            ...
                                            className="w-full bg-black border border-white/10 rounded-xl px-4 py-3.5 md:py-3 text-white text-base appearance-none focus:outline-none focus:border-[#FFD700] focus:ring-1 focus:ring-[#FFD700] transition-all"
                                        >
                                    ...
                                    <div className="space-y-1.5 md:space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full bg-black border border-white/10 rounded-xl px-4 py-3.5 md:py-3 text-white text-base focus:outline-none focus:border-[#FFD700] focus:ring-1 focus:ring-[#FFD700] transition-all resize-none"
